...
// 实数矩阵列和范数计算
void runRealNorm(ofstream& res, Matrix<double>& A) {
    cout << "\nMatrix A:\n" << A;
    res << "Matrix A:\n" << A << "\n";
    ...
    double col_norm = A.norm_col();
    cout << "Column Sum Norm (1-Norm) = " << col_norm << "\n";
    res << "Column Sum Norm = " << col_norm << "\n";
}

// 复数矩阵列和范数计算
void runComplexNorm(ofstream& res, Matrix<Complex>& A) {
    cout << "\nMatrix A:\n" << A;
    res << "Matrix A:\n" << A << "\n";
...
int main(int argc, char* argv[]) {
    ofstream resultFile("matrix_col_norm_result.txt");
    cout << fixed << setprecision(4);
    resultFile << fixed << setprecision(4);

    cout << "===== AUTO Matrix Column Sum Norm (REAL + COMPLEX) =====\n";
    cout << "Column Sum Norm = 1-Norm\n\n";
    resultFile << "===== AUTO Matrix Column Sum Norm =====\n\n";
    ...
    cout << "\nResult saved to matrix_col_norm_result.txt\n";
    resultFile.close();
    return 0;
}