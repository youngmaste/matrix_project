...
// 实数矩阵乘法
void runRealMul(ofstream& res, Matrix<double>& A, Matrix<double>& B) {
    cout << "\nMatrix A:\n" << A;
    cout << "\nMatrix B:\n" << B;
    res << "Matrix A:\n" << A << "\n";
    res << "Matrix B:\n" << B << "\n";
    ...
    try {
        ...
        cout << "Error: Dimension mismatch! A cols must equal B rows.\n";
        res << "Error: Dimension mismatch! A cols must equal B rows.\n";
    }
}

// 复数矩阵乘法
void runComplexMul(ofstream& res, Matrix<Complex>& A, Matrix<Complex>& B) {
    cout << "\nMatrix A:\n" << A;
    cout << "\nMatrix B:\n" << B;
    res << "Matrix A:\n" << A << "\n";
    res << "Matrix B:\n" << B << "\n";
...
int main(int argc, char* argv[]) {
    ofstream resultFile("matrix_mul_result.txt");
    cout << fixed << setprecision(2);
    resultFile << fixed << setprecision(2);

    cout << "===== AUTO Matrix Multiplication (REAL + COMPLEX) =====\n";
    cout << "Calculation: A * B\n\n";
    resultFile << "===== AUTO Matrix Multiplication =====\n\n";
    ...
    cout << "\nResult saved to matrix_mul_result.txt\n";
    resultFile.close();
    return 0;
}